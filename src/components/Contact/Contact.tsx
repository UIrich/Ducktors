import {
  ...
  const confetti = {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_ch5agwd', 'template_1w8ay3o', e.target, 'KJyza3QKtvVqvG98S')
        .then((result) => {
  ...
  export default function ContactFormWithSocialButtons() {
    const { hasCopied, onCopy } = useClipboard('siteducktors@outlook.com');
            ...
            <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
              ...
              <Stack
                ...
                <Stack
                  ...
                  <Link href="http://twitter.com/ducktorswebsite">
                    <IconButton
                      aria-label="twitter"
                      variant="ghost"
                      size="lg"
